...
-- colors.lua is generated by matugen at ~/.config/hypr/colors.lua.
-- Same fresh-install gotcha as before: doesn't exist until a wallpaper is picked
-- through the Quickshell picker, so this require will error until then.
...
-- Bezier curve (was `bezier = myBezier, 0.05, 0.9, 0.1, 1.05` in hyprlang)
